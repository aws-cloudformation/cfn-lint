...
| E1001 <a name="E1001"></a> | Basic CloudFormation Template Configuration | Making sure the basic CloudFormation template componets are propery configured | Basic Template validation | `base` |
...
| E2002 <a name="E2002"></a> | Parameters have appropriate type | Making sure the parameters have a correct type | [source](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/best-practices.html#parmtypes), [source](https://aws.amazon.com/blogs/devops/using-the-new-cloudformation-parameter-types/), [source](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/parameters-section-structure.html#aws-specific-parameter-types) | `parameters` |
...
| E2502 <a name="E2502"></a> | Check if IamInstanceProfile are using the name and not ARN | See if there are any properties IamInstanceProfileare using name and not ARN | Unknown | `properties` |
| E2503 <a name="E2503"></a> | Resource ELB Properties | See if Elb Resource Properties are set correctly HTTPS has certificate HTTP has no certificate | [source](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-elb-listener.html), [source](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticloadbalancingv2-listener.html) | `properties`,`elb` |
...
| E2520 <a name="E2520"></a> | Check Properties that are mutually exclusive | Making sure CloudFormation properties that are exclusive are not defined | Resource Specification | `resources` |
| E2521 <a name="E2521"></a> | Check Properties that are required together | Make sure CloudFormation resource properties are included together when required | Resource Specification | `resources` |
| E2522 <a name="E2522"></a> | Check Properties that need at least one of a list of properties | Making sure CloudFormation properties that require at least one property from a list. More than one can be included. | Resource Specification | `resources` |
| E2523 <a name="E2523"></a> | Check Properties that need only one of a list of properties | Making sure CloudFormation properties that require only one property from a list. One has to be specified. | Resource Specification | `resources` |
...
| E2540 <a name="E2540"></a> | CodePipeline Stages | See if CodePipeline stages are set correctly | Unknown | `properties`,`codepipeline` |
| E2541 <a name="E2541"></a> | CodePipeline Stage Actions | See if CodePipeline stage actions are set correctly | Unknown | `resources`,`codepipeline` |
| E3001 <a name="E3001"></a> | Basic CloudFormation Resource Check | Making sure the basic CloudFormation resources are propery configured | Resource Specification | `resources` |
| E3002 <a name="E3002"></a> | Resource properties are valid | Making sure that resources properties are propery configured | Resource Specification | `resources` |
| E3003 <a name="E3003"></a> | Required Resource Parameters are missing | Making sure that Resources properties that are required exist | Resource Specification | `resources` |
| E3004 <a name="E3004"></a> | Resource dependencies are not circular | Check that Resources are not circularly dependent by Ref, Sub, or GetAtt | Resource Specification | `resources`,`circularly` |
| E3005 <a name="E3005"></a> | Check DependsOn values for Resources | Check that the DependsOn values are valid | Resource Specification | `resources`,`dependson` |
...
| E3012 <a name="E3012"></a> | Check resource properties values | Checks resource property values with Primitive Types for values that match those types. | Resource Specification | `resources` |
...
| E6003 <a name="E6003"></a> | Outputs have values of strings | Making sure the outputs have strings as values | Resource Specification | `outputs` |
...
| W2001 <a name="W2001"></a> | Check if Parameters are Used | Making sure the parameters defined are used | Best Practice | `parameters` |
...
| W3005 <a name="W3005"></a> | Check obsolete DependsOn configuration for Resources | Check if DependsOn is specified if not needed. A Ref and GetAtt implicitly results in DependsOn behaviour. | [source](https://aws.amazon.com/blogs/devops/optimize-aws-cloudformation-templates/) | `resources`,`dependson` |
| W3010 <a name="W3010"></a> | Availability Zone Parameters should not be hardcoded | Check if an Availability Zone property is hardcoded. | Unknown | `parameters`,`availabilityzone` |
...
| W7001 <a name="W7001"></a> | Check if Mappings are Used | Making sure the mappings defined are used | Best Practice | `conditions` |
| W8001 <a name="W8001"></a> | Check if Conditions are Used | Making sure the conditions defined are used | Best Practice | `conditions` |
