...
| -b, --ignore-bad-template | ignore_bad_template | | Suppress the `Template file not found` error. This is useful for suppressing errors caused by wildcards that expand to no files |
