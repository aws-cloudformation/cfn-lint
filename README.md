...
| --convert                  |                      | json                                           | Write the template out in the specified format instead of linting it. Short form intrinsic functions are converted to their long form. Takes one template or reads from stdin, and writes to stdout or `--output-file`                                  |
...
repos:
  - repo: https://github.com/aws-cloudformation/cfn-lint
    rev: v1.56.1 # The version of cfn-lint to use
    hooks:
      - id: cfn-lint
