...
use crate::yaml::scanner::{Marker, ScanError, Scanner, TScalarStyle, Token, TokenType};
...
/// # Example
/// ```
/// # use cfn_ast::yaml::parser::{Event, EventReceiver, Parser};
/// #
...
impl<T: Iterator<Item = char>> Parser<T> {
    ...
    fn load_document<R: MarkedEventReceiver>(
        ...
        if ev != Event::DocumentEnd {
            return Err(ScanError::new(mark, "expected document end"));
        }
        recv.on_event(ev, mark);
