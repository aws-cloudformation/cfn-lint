    use super::*;
    use crate::ast::{AstNode, ArrayNode, BoolNode, NullNode, NumberNode, ObjectEntry, ObjectNode, Position, Span, StringNode};
    use crate::parser;
    use serde_json::json;
...
"#;
    ...
    fn test_engine_catches_long_description() {
        ...
        let regions = vec!["us-east-1".to_string()];
        let issues = engine.validate(&tmpl, &root, &regions);
        let e1003_issues: Vec<_> = issues.iter().filter(|i| i.rule_id.as_deref() == Some("E1003")).collect();
        ...
        let root = make_template_ast_raw(
            ...
            AstNode::Object(ObjectNode {
                entries: vec![ObjectEntry {
                    key_node: AstNode::String(StringNode { value: "BucketName".to_string(), span: Span::default() }),
    ...
    fn test_schema_validation_resource_without_properties_skipped() {
        ...
        resources.push(ObjectEntry {
            key_node: AstNode::String(StringNode { value: "Handle".to_string(), span: Span::default() }),
        ...
        let props = AstNode::Object(ObjectNode {
            entries: vec![ObjectEntry {
                ...
                value: AstNode::Function(crate::ast::FunctionNode {
                    ...
                    span: Span { start: Position { line: 5, column: 7 }, end: Position { line: 5, column: 7 } },
                }),
                key_span: Span::default(),
            }],
            span: Span::default(),
    ...
    fn test_unresolvable_ref_left_as_is_no_crash() {
        ...
        params.push(ObjectEntry {
            key_node: AstNode::String(StringNode { value: "UnknownParam".to_string(), span: Span::default() }),
            key: "UnknownParam".to_string(),
            value: AstNode::Object(ObjectNode { entries: param_props, span: Span::default(),
            }),
            key_span: Span::default(),
        });
        root_props.push(ObjectEntry {
            key_node: AstNode::String(StringNode { value: "Parameters".to_string(), span: Span::default() }),
            key: "Parameters".to_string(),
            value: AstNode::Object(ObjectNode { entries: params, span: Span::default(),
            }),
            key_span: Span::default(),
        });
        ...
        bucket_props.push(ObjectEntry {
            ...
            value: AstNode::Function(crate::ast::FunctionNode {
                ...
                span: Span { start: Position { line: 8, column: 7 }, end: Position { line: 8, column: 7 } },
            }),
            key_span: Span::default(),
        });
        res_inner.push(ObjectEntry {
            ...
            value: AstNode::Object(ObjectNode { entries: bucket_props, span: Span::default(),
            }),
            key_span: Span::default(),
        });
        let mut resources: Vec<ObjectEntry> = Vec::new();
    ...
    fn make_template_ast_raw(resource_type: &str, props_node: AstNode) -> AstNode {
        ...
        AstNode::Object(ObjectNode { entries: root_props, span: Span::default(),
        })
    }
            ...
            serde_json::Value::Object(map) => {
                ...
                for (k, v) in map {
                    props.push(ObjectEntry {
                        key_node: AstNode::String(StringNode { value: k.clone(), span: Span::default() }),
                        key: k.clone(),
                        value: json_to_ast(v),
                        key_span: Span::default(),
                    });
    ...
    fn make_template_with_metadata(
        ...
        let mut root_props: Vec<ObjectEntry> = Vec::new();
        root_props.push(ObjectEntry {
            key_node: AstNode::String(StringNode { value: "AWSTemplateFormatVersion".to_string(), span: Span::default() }),
        ...
        if !template_ignores.is_empty() {
            ...
            config_props.push(ObjectEntry {
                key_node: AstNode::String(StringNode { value: "ignore_checks".to_string(), span: Span::default() }),
            ...
            cfn_lint_props.push(ObjectEntry {
                key_node: AstNode::String(StringNode { value: "config".to_string(), span: Span::default() }),
                key: "config".to_string(),
                value: AstNode::Object(ObjectNode { entries: config_props, span: Span::default(),
                }),
                key_span: Span::default(),
            });
            let mut meta_props: Vec<ObjectEntry> = Vec::new();
                 meta_props.push(ObjectEntry {
                     key_node: AstNode::String(StringNode { value: "cfn-lint".to_string(), span: Span::default() }),
                     key: "cfn-lint".to_string(),
                     value: AstNode::Object(ObjectNode { entries: cfn_lint_props, span: Span::default(),
                }),
                     key_span: Span::default(),
                 });
            root_props.push(ObjectEntry {
                key_node: AstNode::String(StringNode { value: "Metadata".to_string(), span: Span::default() }),
                key: "Metadata".to_string(),
                value: AstNode::Object(ObjectNode { entries: meta_props, span: Span::default(),
                }),
                key_span: Span::default(),
            });
        }
        ...
        for res_name in &resource_names {
            let mut res_props: Vec<ObjectEntry> = Vec::new();
                ...
                res_props.push(ObjectEntry {
                    key_node: AstNode::String(StringNode { value: "Properties".to_string(), span: Span::default() }),
                    key: "Properties".to_string(),
                    value: AstNode::Object(ObjectNode { entries: Vec::new(), span: Span::default(),
                }),
                    key_span: Span::default(),
                });
            ...
            resources.push(ObjectEntry {
                key_node: AstNode::String(StringNode { value: res_name.clone(), span: Span::default() }),
                key: res_name.clone(),
                value: AstNode::Object(ObjectNode { entries: res_props, span: Span::default(),
                }),
                key_span: Span::default(),
    ...
    fn test_resource_level_suppression_only_affects_that_resource() {
        ...
        let issue_suppressed = ValidationError {
            ...
            span: Span { start: Position { line: 5, column: 1 }, end: Position { line: 5, column: 1 } },
            keyword: String::new(),
            unknown: false,
        ...
        let issue_normal = ValidationError {
            ...
            span: Span { start: Position { line: 10, column: 1 }, end: Position { line: 10, column: 1 } },
            keyword: String::new(),
            unknown: false,
            resolved_from_ref: false,
            context: vec![],
    ...
    fn test_schema_if_then_else_enforced() {
        ...
        assert!(
            issues.iter().any(|i| i.message.contains("enum") || i.message.contains("not one of")),
    ...
    fn test_schema_allof_with_anyof_enforced() {
        ...
        let issues: Vec<_> = engine
            ...
            .collect();
        assert!(
            issues.iter().any(|i| i.message.contains("ResourceIdentifier")),
    ...
    fn test_serverless_resources_no_schema_no_issues() {
        ...
        let mut func_props: Vec<ObjectEntry> = Vec::new();
             ...
             func_props.push(ObjectEntry {
                 ...
                 value: AstNode::Object(ObjectNode {
                    entries: vec![ObjectEntry {
                        key_node: AstNode::String(StringNode { value: "Runtime".to_string(), span: Span::default() }),
        ...
        let mut resources: Vec<ObjectEntry> = Vec::new();
        resources.push(ObjectEntry {
            key_node: AstNode::String(StringNode { value: "MyFunc".to_string(), span: Span::default() }),
            key: "MyFunc".to_string(),
            value: AstNode::Object(ObjectNode { entries: func_props, span: Span::default(),
            }),
            key_span: Span::default(),
        });
        root_props.push(ObjectEntry {
        ...
        let schema_issues: Vec<_> = engine
            .validate(&tmpl, &root, &["us-east-1".to_string()])
            .into_iter()
            .filter(|i| matches!(i.rule_id.as_deref().unwrap_or(""), "E3012" | "E3002" | "E3003" | "E3006"))
            .collect();
        assert!(
...
"#;
        ...
        let issues: Vec<_> = engine
            ...
            .collect();
        assert!(issues.is_empty(), "Valid attribute should not trigger E1010, got: {:?}", issues);
    }
...
"#;
        ...
        let issues: Vec<_> = engine
            ...
            .filter(|i| i.rule_id.as_deref() == Some("E1010"))
            .collect();
        assert!(issues.is_empty(), "Custom resources should accept any attribute");
    }
...
"#;
        ...
        assert!(issues.is_empty(), "Missing resource should not trigger E1010");
    }
...
"#;
    ...
    fn test_e3501_registered() {
        ...
        assert!(engine.keyword_rules.all_rules().iter().any(|r| r.id() == "E3501"));
    }
    ...
    fn test_extension_schema_lambda_zipfile_without_runtime_triggers_e3501() {
        ...
        assert!(
            issues.iter().any(|i| i.message.to_lowercase().contains("runtime")),
    ...
    fn test_real_data_sam_serverless_function_schema_validation() {
        ...
        let issues: Vec<_> = engine
            ...
            .collect();
        assert!(
            issues.iter().any(|i| i.message.contains("CompletelyFakeProperty")),
    ...
    fn test_ref_novalue_object_property_produces_e3003() {
        ...
        let props = AstNode::Object(ObjectNode {
            entries: vec![ObjectEntry {
                key_node: AstNode::String(StringNode { value: "Tags".to_string(), span: Span::default() }),
                key: "Tags".to_string(),
                value: AstNode::Array(crate::ast::ArrayNode {
                    elements: vec![AstNode::Object(ObjectNode {
                        entries: vec![
                            ObjectEntry {
                                ...
                                value: AstNode::Function(crate::ast::FunctionNode {
                                    ...
                                    span: Span { start: Position { line: 5, column: 11 }, end: Position { line: 5, column: 11 } },
                                }),
                                key_span: Span::default(),
                            },
                            ObjectEntry {
                                key_node: AstNode::String(StringNode { value: "Value".to_string(), span: Span::default() }),
                                key: "Value".to_string(),
                                value: AstNode::String(StringNode {
                        ...
                        span: Span { start: Position { line: 5, column: 9 }, end: Position { line: 5, column: 9 } },
                    })],
                    span: Span::default(),
                }),
                key_span: Span::default(),
    ...
    fn test_ref_novalue_properties_level_produces_e3012() {
        ...
        let props = AstNode::Function(crate::ast::FunctionNode {
            ...
            span: Span { start: Position { line: 5, column: 5 }, end: Position { line: 5, column: 5 } },
        });
    ...
    fn test_resolve_data_refs_lookup_resolves_known_key() {
        let gathered = AstNode::Object(ObjectNode {
            entries: vec![ObjectEntry {
                key_node: AstNode::String(StringNode { value: "target".to_string(), span: Span::default() }),
                key: "target".to_string(),
                value: AstNode::Object(ObjectNode {
                    entries: vec![ObjectEntry {
                        key_node: AstNode::String(StringNode { value: "resourceType".to_string(), span: Span::default() }),
    ...
    fn test_resolve_data_refs_lookup_unknown_key_drops_const() {
        ...
        assert!(resolved.get("const").is_none(), "const should be dropped for unresolved $lookup, got: {:?}", resolved);
    }

    #[test]
    fn test_resolve_data_refs_lookup_missing_data_drops_const() {
        let gathered = AstNode::Object(ObjectNode { entries: Vec::new(), span: Span::default(),
        });
        ...
        let resolved = resolve_data_refs(&schema, &gathered);
        assert!(resolved.get("const").is_none(), "const should be dropped when $data can't resolve");
    }
    ...
    fn test_resolve_data_refs_data_still_works() {
        let gathered = AstNode::Object(ObjectNode {
            entries: vec![ObjectEntry {
                key_node: AstNode::String(StringNode { value: "source".to_string(), span: Span::default() }),
                key: "source".to_string(),
                value: AstNode::Object(ObjectNode {
                    entries: vec![ObjectEntry {
                        key_node: AstNode::String(StringNode { value: "fifo".to_string(), span: Span::default() }),
                        key: "fifo".to_string(),
...
fn debug_e3023_full() {
    ...
    let mut engine = Engine::with_data_dir(data_dir);
    let issues = engine.validate(&tmpl, &ast, &["us-east-1".to_string()]);
    for i in issues.iter().filter(|i| i.rule_id.as_deref() == Some("E3023")) {
        eprintln!("rs {:3} {}", i.span.start.line + 1, i.message.chars().take(90).collect::<String>());
    }
    eprintln!("Total: {}", issues.iter().filter(|i| i.rule_id.as_deref() == Some("E3023")).count());
}
