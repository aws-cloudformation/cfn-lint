...
/// I3010: Resource limit approaching.
///
/// Now handled by the parent schema rule via child-rule mapping.
pub struct I3010;

impl CfnLintRule for I3010 {
    fn id(&self) -> &str { "I3010" }
    fn short_description(&self) -> &str { "Resource limit" }
...
crate::register_cfn_lint_rule!(I3010);
