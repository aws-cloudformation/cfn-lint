...
/// I3012: Resource name approaching max length.
///
/// Now handled by the parent schema rule via child-rule mapping.
pub struct I3012;

impl CfnLintRule for I3012 {
    fn id(&self) -> &str { "I3012" }
    fn short_description(&self) -> &str { "Resource name limit" }
...
crate::register_cfn_lint_rule!(I3012);
