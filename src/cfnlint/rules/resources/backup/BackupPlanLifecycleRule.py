...
class BackupPlanLifecycleRule(CloudFormationLintRule):
    ...
    description = (
        'Check that Backup plans with lifecycle rules have >= 90 days '
        'between cold and delete'
    )
    source_url = 'https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-backup-backupplan-lifecycleresourcetype.html'  # noqa: E501
    ...
    def match(self, cfn):
        ...
        for result in results:
            ...
            if isinstance(
                backup_rule.get('MoveToColdStorageAfterDays'),
                int,
                ...
                if (
                    ...
                    message = (
                        'DeleteAfterDays in {0} must be at least 90 '
