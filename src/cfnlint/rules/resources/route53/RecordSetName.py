...
class RecordSetName(CloudFormationLintRule):
    ...
    description = (
        'In a RecordSet, the HostedZoneName must be a superdomain '
        'of the Name being validated'
    )
    source_url = 'https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordset.html#cfn-route53-recordset-name'  # noqa: E501
    ...
    def match_resource_properties(self, properties, _, path, cfn):
        ...
        for property_set in property_sets:
            ...
            if isinstance(name, str) and isinstance(hz_name, str):
                ...
                if hz_name not in [name, name[-len(hz_name) :]]:  # noqa: E203
