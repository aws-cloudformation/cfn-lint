...
class DbInstanceBackupRetentionPeriod(CfnLintJsonSchema):
    id = "E3683"
    shortdesc = (
        "Check RDS DB instances with auto expiring content "
        "have explicit retention period"
    )
    description = (
    ...
    def awsrdsdbinstancebackupretentionperiod(self, validator, _, instance, schema):
