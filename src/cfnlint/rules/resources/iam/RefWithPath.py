...
class RefWithPath(CloudFormationLintRule):
    ...
    source_url = 'https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements.html'  # noqa: E501
    tags = ['properties', 'iam']
    ...
    def check_ref(self, value, parameters, resources, path):  # pylint: disable=W0613
        ...
        if iam_path != '/':
            message = "When using a Ref to IAM resource the Path must be '/'. "
