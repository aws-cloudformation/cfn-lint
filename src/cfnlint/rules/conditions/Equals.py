...
class Equals(CloudFormationLintRule):
    ...
    source_url = 'https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/intrinsic-function-reference-conditions.html#intrinsic-function-reference-conditions-equals'  # noqa: E501
                    ...
                    if valid_ref:
                        if valid_ref.get('From') == 'Parameters':
                            if valid_ref.get('Type') in VALID_PARAMETER_TYPES_LIST:
                                message = (
                                    'Every Fn::Equals object requires a list '
                                    'of 2 string parameters'
                                )
