...
def py_scanstring(s, end, strict=True, _b=BACKSLASH, _m=STRINGCHUNK.match):
    ...
    while 1:
        ...
        if esc != 'u':
            ...
            if 0xD800 <= uni <= 0xDBFF and s[end : end + 2] == '\\u':  # noqa: E203
...
def py_make_scanner(context):
    ...
    def _scan_once(string, idx):
        ...
        if nextchar == 'n' and string[idx : idx + 4] == 'null':  # noqa: E203
            return None, idx + 4
        if nextchar == 't' and string[idx : idx + 4] == 'true':  # noqa: E203
            return True, idx + 4
        if nextchar == 'f' and string[idx : idx + 5] == 'false':  # noqa: E203
            return False, idx + 5
        ...
        if m is not None:
            ...
            return res, m.end()
        if nextchar == 'N' and string[idx : idx + 3] == 'NaN':  # noqa: E203
            return parse_constant('NaN'), idx + 3
        if nextchar == 'I' and string[idx : idx + 8] == 'Infinity':  # noqa: E203
            return parse_constant('Infinity'), idx + 8
        if nextchar == '-' and string[idx : idx + 9] == '-Infinity':  # noqa: E203
...
class CfnJSONDecoder(json.JSONDecoder):
    ...
    def cfn_json_object(
        ...
        nextchar = s[end : end + 1]  # noqa: E203
