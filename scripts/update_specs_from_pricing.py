...
def main():
    ...
    write_output('aws-redshift-cluster', 'nodetype-enum', get_results('AmazonRedshift', ['Compute Instance']))
    write_output('aws-dax-cluster', 'nodetype-enum', get_dax_pricing())
    write_output('aws-docdb-dbinstance', 'dbinstanceclass-enum', get_results('AmazonDocDB', ['Database Instance']))
    write_output('aws-neptune-dbinstance', 'dbinstanceclass-enum', get_results('AmazonNeptune', ['Database Instance']))
    write_output('aws-elasticache-cachecluster', 'cachenodetype-enum', get_results('AmazonElastiCache', ['Cache Instance']))
    write_output('aws-elasticsearch-domain', 'elasticsearchclusterconfig-instancetype-enum', get_results('AmazonES', ['Elastic Search Instance']))
    write_output('aws-emr-cluster', 'instancetypeconfig-instancetype-enum', get_results('ElasticMapReduce', ['Elastic Map Reduce Instance']))
    write_output('aws-managedblockchain-node', 'nodeconfiguration-instancetype-enum', get_results('AmazonManagedBlockchain', ['Blockchain Instance']))
    write_output('aws-gamelift-fleet', 'ec2instancetype-enum', get_results('AmazonGameLift', ['GameLift EC2 Instance']))
    write_output('aws-appstream-fleet', 'instancetype-enum', get_results('AmazonAppStream', ['Streaming Instance']))
