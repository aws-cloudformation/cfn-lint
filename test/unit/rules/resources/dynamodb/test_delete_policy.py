...
from cfnlint.rules.resources.UpdateReplacePolicyDeletionPolicyOnStatefulResourceTypes import UpdateReplacePolicyDeletionPolicyOnStatefulResourceTypes  # pylint: disable=E0401
