...
from cfnlint.rules.resources.backup.BackupPlanLifecycleRule import BackupPlanLifecycleRule  # pylint: disable=E0401
...
class TestBackupPlanLifecycleRule(BaseRuleTestCase):
    ...
    def test_file_negative(self):
        """Test failure"""
        self.helper_file_negative('test/fixtures/templates/bad/resources/backup/test_backup_plan_lifecycle_rule.yml', 1)
