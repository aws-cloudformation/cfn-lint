...
from cfnlint.rules.resources.properties.UnwantedBasedOnValue import UnwantedBasedOnValue  # pylint: disable=E0401
...
class TestUnwantedBasedOnValue(BaseRuleTestCase):
    ...
    def test_file_negative(self):
        ...
        self.helper_file_negative(
            'test/fixtures/templates/bad/resources/properties/unwanted_based_on_value.yaml', 3)
