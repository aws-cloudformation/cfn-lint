...
from cfnlint.rules.resources.RetentionPeriodOnResourceTypesWithAutoExpiringContent import RetentionPeriodOnResourceTypesWithAutoExpiringContent  # pylint: disable=E0401
...
class TestRetentionPeriodOnResourceTypesWithAutoExpiringContent(BaseRuleTestCase):
    ...
    def test_file_negative_alias(self):
        ...
        self.helper_file_negative(
            'test/fixtures/templates/bad/resources/sqs/retention_period.yaml', 1)