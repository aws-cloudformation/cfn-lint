...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [
                ValidationError(
                    "'10.0.0.0/24' overlaps with '10.0.0.0/24'",
                    rule=VpcSubnetCidr(),
                    path_override=deque(
                        ["Resources", "VpcV4Subnet1", "Properties", "CidrBlock"]
                    ),
        ...
        (
            "Valid overlapping subnets with mixing types",
            {"CidrBlock": "10.0.0.0/16"},
            {
                "Resources": {
                    "Vpc": {
        ...
        (
            "Invalid overlapping ipv6 addresses",
            {"CidrBlock": "10.0.0.0/16"},
            {
                "Resources": {
                    "Vpc": {
