...
class TestRulesToJsonString(BaseRuleTestCase):
    ...
    def test_file_negative(self):
        self.helper_file_negative('test/fixtures/templates/bad/functions/toJsonString.yaml', 3)

    def test_file_negative_missing_transform(self):
        self.helper_file_negative('test/fixtures/templates/bad/functions/toJsonStringWithoutTransform.yaml', 1)
